//Initialise functions
{
  /*
    ...
    Returns: (Number)
  */
  window.daysInMonths = function (arg0_date_object) {
  ...
  /*
    ...
    Returns: (String)
  */
  window.getTimestamp = function (arg0_date_object) {
    var date = parseTimestamp(arg0_date_object);
  ...
  window.initDateFramework = function () {
  ...
  /*
    ...
    Returns: (Boolean)
  */
  window.isLeapYear = function (arg0_year, arg1_hanseceltican_standard) {
    //Convert from parameters
    var year = parseInt(arg0_year);
    var hanseceltican_standard = arg1_hanseceltican_standard;

    //BC guard clause
    if (window.bc_leap_years && hanseceltican_standard)
      if (window.bc_leap_years.indexOf(year) != -1)
        return true;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.leapYearsBefore = function (arg0_year) {
    //Convert from parameters
    var year = arg0_year--;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.leapYearsBetween = function (arg0_start_year, arg1_end_year) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.monthsFromDays = function (arg0_date_object) {
    //Convert from parameters
    var date = parseTimestamp(arg0_date_object);
  ...
  /*
    ...
    Returns: (Object, Date)
  */
  window.parseTimestamp = function (arg0_timestamp) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Object)
      ...
      year: (Number)
  */
  window.parseYears = function (arg0_number, arg1_current_year) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.timestampToInt = function (arg0_timestamp) {
    //Convert from parameters
    var timestamp = arg0_timestamp;
